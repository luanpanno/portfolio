...
export const projects: Project[] = [
  {
    imageUrl: '/images/projects/elena-joy.png',
    name: 'Elena Joy',
    stack: 'HTML and CSS',
  ...
  {
    imageUrl: '/images/projects/github-search.png',
    name: 'Github Search',
    stack: 'React with TypeScript',
